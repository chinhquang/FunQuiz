...
public class SignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtUsername.setText(sharedPreferences.getString("taikhoan",""));
        checkBoxNhoMatKhau.setChecked(sharedPreferences.getBoolean("checked",false));
    ...
    void Inflate() {
        ...
        checkBoxNhoMatKhau = (CheckBox) findViewById(R.id.cbNhoMatKhau);
    }
